...
import { ClassicMobileMockup } from '@/components/ui/ClassicMobileMockup';
  ...
  return (
    <main className="w-full min-h-screen bg-transparent overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative h-[90vh] md:h-[100vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-brand-primary/10 via-black/60 to-black/80 pointer-events-none z-20" />
        <Container className="relative z-30">
          <div className="max-w-4xl">
            <h1 className="text-[clamp(2rem,8vw,6rem)] font-bold mb-6 uppercase tracking-tight leading-tight heading-gradient pl-1 mono-heading">
              3D Real Estate <br />
      ...
      <div className="content-wrap">
        ...
        <Section className="py-32 border-y border-white/5 relative overflow-hidden bg-transparent">
          ...
          <Container className="relative z-10">
            ...
            <div className="text-center mb-24 fade-in-section">
              ...
              <h2 className="text-5xl md:text-7xl font-bold mb-6 uppercase tracking-tight heading-gradient drop-shadow-2xl pl-1">Key Features</h2>
            ...
            {/* STEP 5 — SALES IMPACT STRIP - REDESIGNED */}
            <div className="relative mb-32 py-12 md:py-16 px-8 md:px-12 fade-in-section rounded-[2rem] bg-zinc-950/85 border border-white/10 backdrop-blur-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.8)] overflow-hidden">
              {/* Animated Background Gradient */}
              <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/5 via-transparent to-brand-primary/5 opacity-50" />
              ...
              <div className="relative z-10 flex flex-col xl:flex-row items-center gap-12 xl:gap-20">
                <div className="flex-shrink-0 text-center xl:text-left">
                  <h3 className="text-4xl md:text-6xl font-bold uppercase tracking-tight text-white leading-[0.9] mb-2">
                    Built to <br /> 
                    <span className="text-brand-primary">Sell Faster</span>
                  </h3>
                  <p className="text-white/40 uppercase tracking-[0.3em] text-xs font-semibold mt-4">Performance Engineered</p>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                  {[
                    { icon: Sparkles, title: 'Engagement', text: 'Buyers understand spaces better than static photos' },
                    { icon: Layers, title: 'Retention', text: '3x more time spent on listing pages' },
                    { icon: Box, title: 'Conversion', text: 'Faster decision making with immersive context' }
                  ].map((item, i) => (
                    <div key={i} className="group relative p-6 rounded-2xl bg-white/[0.03] border border-white/5 hover:bg-white/[0.06] hover:border-brand-primary/30 transition-all duration-500">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-12 h-12 rounded-xl bg-brand-primary/10 border border-brand-primary/20 flex items-center justify-center text-brand-primary transition-transform duration-500 group-hover:scale-110">
            ...
            <div className="relative z-10 max-w-4xl mx-auto flex items-center justify-center gap-2 md:gap-4 px-4">
              <span className="text-brand-primary text-6xl md:text-8xl font-serif leading-none select-none -translate-y-4 inline-block">&ldquo;</span>
              <p className="text-xl md:text-3xl text-white/90 font-light tracking-tight leading-tight font-bricolage italic px-2">
              ...
              <span className="text-brand-primary text-6xl md:text-8xl font-serif leading-none select-none translate-y-4 inline-block">&rdquo;</span>
            </div>
            </div>
          </Container>
        </Section>
        ...
        {/* Total Layout Perspective / Dollhouse Section */}
        <Section className="py-6 relative overflow-hidden">
          ...
          <Container className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
              ...
              <div className="relative group px-4 md:px-0">
                <div className="relative h-[240px] md:h-[300px] lg:h-[400px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                  <Image
                    ...
                    alt="3D Dollhouse perspective view"
                    fill
              ...
              {/* Text Right */}
              <div className="flex flex-col justify-center py-2 px-6 md:px-0">
                <h2 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight heading-gradient leading-tight">
                  Total Layout Perspective. <br />
                  <span className="text-brand-primary">Orbital Views.</span>
                </h2>
                
                <div className="space-y-6">
                  <p className="text-lg md:text-xl text-white font-light leading-relaxed">
                    View your property from every possible angle. Our top-down and orbit views provide an unparalleled sense of scale.
                  </p>
                  
                  <p className="text-base md:text-lg text-white/70 font-light leading-relaxed">
                    Help buyers understand the complete architecture of their future home. With clickable room labels and intelligent camera transitions, navigating through complex property layouts becomes as simple as a tap.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                  <div className="lg:col-span-7">
                    ...
                    <h3 className="text-4xl md:text-6xl font-bold mb-10 text-white tracking-widest uppercase leading-[1.1]">
                      Smart <span className="text-brand-primary">CRM</span>
                    </h3>
        ...
        {/* Mobile Showcase - REDESIGNED */}
        <Section className="py-24 bg-transparent border-t border-white/5 overflow-hidden">
          <Container>
            <div className="fade-in-section grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              {/* Text Top */}
              <div className="lg:col-span-12 text-center mb-12">
                <h2 className="text-4xl md:text-6xl font-bold mb-8 uppercase tracking-tight heading-gradient leading-tight">
                  Let your virtual <br />
                  <span className="text-brand-primary">tours shine on mobile</span>
                </h2>
                <div className="space-y-6 max-w-4xl mx-auto">
                  <p className="text-white text-xl md:text-2xl font-light leading-relaxed">
                    Over 50% of your users are on mobile. Give them the best experience! 
                  </p>
                  <p className="text-white/70 text-lg md:text-xl font-light leading-relaxed">
                    With GenX Reality, you get a virtual tour experience engineered for the palm of your hand. Viewers will enjoy your 3D content on a small screen with the same fluid performance and detail as on a desktop.
                  </p>
                </div>
              </div>

              {/* Phones Bottom - Centered and Larger */}
              <div className="lg:col-span-12 w-full flex flex-wrap items-center justify-center gap-8 md:gap-16 overflow-visible py-12">
                <ClassicMobileMockup imageUrl="/crm/2.jpg" type="android" />
                <ClassicMobileMockup imageUrl="/crm/1.jpg" type="android" />
                <ClassicMobileMockup imageUrl="/crm/3.jpg" type="android" />
              </div>
            </div>
          </Container>
        </Section>
