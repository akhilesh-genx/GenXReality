    ...
    <div className="pt-24">
      ...
      <div className="relative h-[50vh] w-full overflow-hidden mb-12">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 md:p-16">
          <Container>
            <h1 className="text-5xl md:text-7xl font-bold mb-4 tracking-tighter">ABOUT <span className="text-brand-primary">GenXReality</span></h1>
      ...
      <Section>
        <Container>
          <div className="max-w-4xl mx-auto text-center mb-24">
            <h2 className="text-4xl md:text-6xl font-bold mb-8 uppercase">Our Mission</h2>
          ...
          <div className="mb-24">
            <h2 className="text-3xl md:text-5xl font-bold mb-12 text-center">Core Pillars</h2>
          ...
          <div className="text-center border-t border-brand-primary/20 pt-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-12">Leadership</h2>
