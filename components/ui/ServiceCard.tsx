  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-8 h-full flex flex-col justify-between">
        <div className="p-3 bg-black/40 backdrop-blur-md rounded-2xl border border-white/5 text-white w-fit transform transition-all duration-500 group-hover:scale-110 group-hover:text-brand-primary group-hover:bg-brand-primary/10 group-hover:border-brand-primary/30 shadow-2xl">
          {icon}
        </div>
        ...
        <div className="transform transition-transform duration-500 translate-y-12 group-hover:translate-y-0">
          <h3 className="text-xl md:text-2xl font-bold mb-3 text-white tracking-widest uppercase origin-left heading-gradient">{title}</h3>
          <p className="text-white text-sm md:text-base leading-relaxed font-light opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
            {description}
          </p>
        </div>
      </div>
